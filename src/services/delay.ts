...
class DelayManager {
      ...
      updates.forEach((queue, key) => {
        ...
        queue.forEach((update) => {
          try {
            ...
            reportSafeClientFailure('delay-item-listener', error)
          }
        })
      })
    }
    ...
    const run = () => {
      ...
      groups.forEach((group) => {
        ...
        try {
          ...
          reportSafeClientFailure('delay-group-listener', error)
        }
      })
    }
  ...
  async checkDelay(
    ...
    try {
      ...
      reportSafeClientFailure('delay-test', error)
  ...
  async checkListDelay(
    ...
    const help = async (): Promise<void> => {
      ...
      try {
        ...
        reportSafeClientFailure('delay-batch-check', error)
        // 设置为错误状态
