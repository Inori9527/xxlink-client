...
// PROVES:         Source text only. A green run proves only facts about source TEXT and
//                 about which paths exist on disk.
// DOES NOT PROVE: That any of this code runs, compiles, or behaves as named.
