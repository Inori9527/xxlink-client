...
export const translationKeys = [
  ...
  'home.components.currentProxy.empty.noSubscription',
  'home.components.currentProxy.empty.goToPlans',
  ...
  'layout.components.navigation.tabs.promoCode',
  ...
  'layout.components.connect.actions.connect',
  'layout.components.connect.actions.disconnect',
  'layout.components.connect.actions.connecting',
  ...
  'layout.components.connect.labels.both',
  'layout.components.connect.labels.upload',
  ...
  'layout.components.connect.labels.connectedHint',
  'layout.components.connect.labels.connectedSecureHint',
  'layout.components.connect.labels.startHint',
  'layout.components.connect.location.chooseHint',
  'layout.components.connect.location.auto',
  'layout.components.connect.location.route',
  'layout.components.connect.location.connected',
  'layout.components.connect.location.lockedHint',
  'layout.components.connect.usage.label',
  'layout.components.connect.region.title',
  'layout.components.connect.region.test',
  'layout.components.connect.region.smartTitle',
  'layout.components.connect.region.smartSummary',
  ...
  'layout.components.connect.empty.refresh',
  'layout.components.connect.empty.rebuild',
  'layout.components.connect.empty.rebuilding',
  'layout.components.connect.empty.refreshing',
  ...
  'layout.components.connect.trial.exceededTitle',
  'layout.components.connect.trial.exceededSubtitle',
  'layout.components.connect.trial.openDashboard',
  'layout.components.connect.session.duration',
  'layout.components.connect.session.traffic',
  ...
  'layout.components.nodes.smart.title',
  'layout.components.nodes.smart.hint',
  'layout.components.nodes.smart.action',
  'layout.components.nodes.search.placeholder',
  ...
  'layout.components.nodes.empty.filteredTitle',
  'layout.components.nodes.empty.filteredSubtitle',
  'layout.components.promoCode.title',
  'layout.components.promoCode.heading',
  'layout.components.promoCode.subtitle',
  'layout.components.promoCode.placeholder',
  'layout.components.promoCode.redeem',
  'layout.components.promoCode.redeeming',
  'layout.components.promoCode.syncing',
  'layout.components.promoCode.retrySync',
  'layout.components.promoCode.syncWarning',
  'layout.components.promoCode.chips.autoSync',
  'layout.components.promoCode.chips.trafficCode',
  'layout.components.promoCode.errors.empty',
  'layout.components.promoCode.errors.redeemFailed',
  'layout.components.promoCode.result.traffic',
  'layout.components.promoCode.result.success',
  'layout.components.announcement.label',
  'layout.components.announcement.dismissHint',
  'layout.components.announcement.viewDetails',
  'layout.components.announcement.dismiss',
  'mine.pageTitle',
  'mine.userFallback',
  'mine.usage',
  'mine.remaining',
  ...
  'mine.rows.connectMode.title',
  'mine.rows.connectMode.description',
  'mine.rows.settings.title',
  'mine.rows.settings.description',
  ...
  'plans.page.sections.promo',
  'plans.page.current.title',
  'plans.page.current.fallback',
  'plans.page.current.expirePrefix',
  'plans.page.current.syncHint',
  'plans.page.current.usageUnavailable',
  'plans.page.current.status.active',
  'plans.page.current.status.expired',
  'plans.page.current.status.cancelled',
  'plans.page.current.labels.trafficUsage',
  'plans.page.current.labels.remaining',
  'plans.page.current.labels.startAt',
  'plans.page.current.labels.expireAt',
  ...
  'plans.page.card.features.devices',
  'plans.page.card.features.devicesValue',
  'plans.page.card.features.duration',
  'plans.page.card.features.validUntilExpire',
  'plans.page.card.actions.purchase',
  'plans.page.card.actions.processing',
  ...
  'plans.page.cached.banner',
  'plans.page.cached.partialFailure',
  'plans.page.form.promoPlaceholder',
  'plans.page.form.promoHelp',
  'plans.page.feedback.copied',
  'plans.page.feedback.errors.loadFailed',
  'plans.page.feedback.errors.purchaseFailed',
  'plans.page.feedback.errors.untrustedCheckout',
  'plans.page.feedback.errors.sessionExpired',
  'plans.page.feedback.errors.networkError',
  'plans.page.feedback.errors.generic',
  'plans.page.periods.month',
  'plans.page.periods.quarter',
  'plans.page.periods.year',
  'plans.page.duration.month',
  'plans.page.duration.months',
  'plans.page.duration.days',
  'plans.trial.title',
  'plans.trial.subtitle',
  'plans.trial.remaining',
  'plans.trial.claim',
  'plans.trial.claiming',
  'plans.trial.claimSuccess',
  'plans.trial.claimFailed',
  'plans.trial.available',
  'plans.trial.cooldown',
  ...
  'profiles.page.title',
  'profiles.page.empty.title',
  'profiles.page.empty.body',
  'profiles.page.empty.goToPlans',
  'profiles.page.empty.refresh',
  'profiles.page.expiringSoon',
  'profiles.page.forceRebuild.button',
  'profiles.page.forceRebuild.confirm',
  'profiles.page.forceRebuild.success',
  ...
  'settings.simplified.pageTitle',
  'settings.simplified.hero.eyebrow',
  'settings.simplified.hero.title',
  'settings.simplified.hero.subtitle',
  'settings.simplified.sections.common',
  'settings.simplified.sections.advanced',
  'settings.simplified.theme.system',
  'settings.simplified.theme.light',
  'settings.simplified.theme.dark',
  'settings.simplified.rows.language.title',
  'settings.simplified.rows.language.description',
  'settings.simplified.rows.theme.title',
  'settings.simplified.rows.theme.description',
  'settings.simplified.rows.autoLaunch.title',
  'settings.simplified.rows.autoLaunch.description',
  'settings.simplified.rows.autoUpdate.title',
  'settings.simplified.rows.autoUpdate.description',
  'settings.simplified.rows.advancedToggle.title',
  'settings.simplified.rows.advancedToggle.description',
  'settings.simplified.rows.tun.title',
  'settings.simplified.rows.tun.description',
  'settings.simplified.rows.bypass.title',
  'settings.simplified.rows.bypass.description',
  'settings.simplified.rows.logs.title',
  'settings.simplified.rows.logs.description',
  'settings.simplified.rows.profileRepair.title',
  'settings.simplified.rows.profileRepair.description',
  'settings.simplified.rows.connections.title',
  'settings.simplified.rows.connections.description',
  'settings.simplified.rows.rules.title',
  'settings.simplified.rows.rules.description',
  'settings.actions.logout',
  'settings.actions.logoutConfirmTitle',
  'settings.actions.logoutConfirmBody',
  ...
  'settings.components.verge.basic.fields.autoConnectOnLaunch',
  ...
  'settings.components.verge.basic.fields.showAdvancedSettings',
  ...
  'shared.auth.forgotPassword',
  'shared.auth.registeredSuccess',
  'shared.auth.cancelGoogleLogin',
  'shared.auth.brand',
  'shared.auth.login.subtitle',
  'shared.auth.login.submit',
  'shared.auth.login.dividerText',
  'shared.auth.login.noAccount',
  'shared.auth.login.goRegister',
  'shared.auth.register.subtitle',
  'shared.auth.register.submit',
  'shared.auth.register.hasAccount',
  'shared.auth.register.goLogin',
  'shared.auth.register.passwordPlaceholder',
  'shared.auth.form.email',
  'shared.auth.form.password',
  'shared.auth.form.confirmPassword',
  'shared.auth.form.showPassword',
  'shared.auth.form.hidePassword',
  'shared.auth.validation.passwordMismatch',
  'shared.auth.validation.passwordTooShort',
  'shared.auth.google.signIn',
  'shared.auth.google.waiting',
  'shared.auth.google.notConfigured',
  'shared.auth.google.accessDenied',
  'shared.auth.google.authFailed',
  'shared.auth.google.missingCode',
  'shared.auth.google.loginFailed',
  'shared.auth.errors.accountExists',
  'shared.auth.errors.invalidCredentials',
  'shared.auth.errors.openBrowser',
  'shared.auth.errors.loginFailed',
  'shared.auth.errors.registerFailed',
  'shared.legal.terms',
  'shared.legal.privacy',
] as const
