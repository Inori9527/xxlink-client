...
pub static IPC_PATH: &str = "/tmp/xxlink/xxlink-service.sock";
#[cfg(all(windows, not(feature = "test")))]
pub static IPC_PATH: &str = r"\\.\pipe\xxlink-service";

#[cfg(all(feature = "test", unix))]
pub static IPC_PATH: &str = "/tmp/xxlink/xxlink-service.sock";
// pub static IPC_PATH: &str = "/tmp/xxlink/xxlink-service-test.sock";
#[cfg(all(feature = "test", windows))]
pub static IPC_PATH: &str = r"\\.\pipe\xxlink-service-test";
